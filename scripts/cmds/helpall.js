...
const doNotDelete = "𓃵 | 𝗭𝗘𝗣𝗛 𝗖𝗠𝗗 𝗟𝗜𝗦𝗧";
/**
* @author NTKhang
	...
	langs: {
		...
		en: {
			help: "╭─────────────◉\n『%6』\n╰─────────────❃\n\n╭─────────────⭓"
				...
				+ "\n├─────𓃵"
				+ "\n│ 📖 𝗣𝗮𝗴𝗲 [ %2/%3 ]"
				+ "\n│ ℹ️ 𝗖𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆, 𝘁𝗵𝗲 𝗯𝗼𝘁 𝗵𝗮𝘀 %4 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘁𝗵𝗮𝘁 𝗰𝗮𝗻 𝗯𝗲 𝘂𝘀𝗲𝗱"
				+ "\n│ ╰┄◉➣ 𝗧𝘆𝗽𝗲 %5help <page> 𝗍𝗈 𝗏𝗂𝖾𝗐 𝗍𝗁𝖾 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝗅𝗂𝗌𝗍"
				+ "\n│ ╰┄◉➣ 𝗧𝘆𝗽𝗲 %5help 𝗍𝗈 𝗏𝗂𝖾𝗐 𝗍𝗁𝖾 𝖽𝖾𝗍𝖺𝗂𝗅𝗌 𝗈𝖿 𝗁𝗈𝗐 𝗍𝗈 𝗎𝗌𝖾 𝗍𝗁𝖺𝗍 𝗰𝗼𝗺𝗺𝗮𝗻𝗱"
				+ "\n├────────❍"
				+ "\n│ ╰┄◉➣ ⧽⧽ 𝗞𝘆𝗹𝗲𝗽𝗼𝗴𝗶 ⧼⧼"
				+ "\n╰─────────────⭓",
			help2: "%1├───────⭔"
				+ "\n│  ℹ️ 𝗖𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆, 𝘁𝗵𝗲 𝗯𝗼𝘁 𝗵𝗮𝘀 %4 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘁𝗵𝗮𝘁 𝗰𝗮𝗻 𝗯𝗲 𝘂𝘀𝗲𝗱, the bot has %2 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀 that can be used"
				+ "\n│ ╰┄◉➣ 𝗧𝘆𝗽𝗲 %3help <command name> 𝗍𝗈 𝗏𝗂𝖾𝗐 𝗍𝗁𝖾 𝖽𝖾𝗍𝖺𝗂𝗅𝗌 𝗈𝖿 𝗁𝗈𝗐 𝗍𝗈 𝗎𝗌𝖾 𝗍𝗁𝖺𝗍 𝗰𝗼𝗺𝗺𝗮𝗻𝗱"
				+ "\n│ %4"
				+ "\n╰─────────────⭓",
